...
from homeassistant.components.metservice_weather.coordinator import (
    WeatherUpdateCoordinator,
    WeatherUpdateCoordinatorConfig,
)
from homeassistant.components.metservice_weather.const import (
    CONDITION_MAP,
    DOMAIN,
)
from homeassistant.components.metservice_weather.coordinator_types import (
    MetServicePublicData,
    HourlyEntry,
    DailyEntry,
)
from homeassistant.components.metservice_weather.weather import (
...
async def test_weather_setup_entry_public(hass):
    from homeassistant.components.metservice_weather.weather import async_setup_entry
...
async def test_public_entity_condition_mapped(hass):
    ...
    entity = MetServiceForecastPublic(coord)
    entity.hass = hass
    with patch("homeassistant.components.metservice_weather.weather.sun_helper.is_up", return_value=True):
...
async def test_public_entity_condition_clear_night(hass):
    ...
    entity = MetServiceForecastPublic(coord)
    entity.hass = hass
    with patch("homeassistant.components.metservice_weather.weather.sun_helper.is_up", return_value=False):
        cond = entity.condition
