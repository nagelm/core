...
from homeassistant.components.metservice_weather.const import DOMAIN, DEFAULT_LOCATION
from homeassistant.components.metservice_weather.config_flow import (
    CONF_MARINE_REGION,
    WeatherFlowHandler,
)
...
async def test_public_with_marine_region(hass, mock_coordinator_refresh):
    ...
    with patch(
        "homeassistant.components.metservice_weather.config_flow.async_get_clientsession",
