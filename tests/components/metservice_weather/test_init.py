...
async def test_setup_and_unload_public(hass):
    ...
    with patch(
        "homeassistant.components.metservice_weather.WeatherUpdateCoordinator.async_config_entry_first_refresh",
...
async def test_unload_returns_true_when_platforms_unload(hass):
    ...
    from homeassistant.components.metservice_weather import async_unload_entry
...
async def test_runtime_data_set_after_setup(hass):
    ...
    from homeassistant.components.metservice_weather.coordinator import WeatherUpdateCoordinator
