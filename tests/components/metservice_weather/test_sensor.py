...
from homeassistant.components.metservice_weather.sensor import WeatherSensor
from homeassistant.components.metservice_weather.weather_current_conditions_sensors import (
...
from homeassistant.components.metservice_weather.coordinator_types import MetServicePublicData
...
async def test_sensor_setup_entry_public_skips_tide_sensors(hass):
    ...
    from homeassistant.components.metservice_weather.sensor import (
        async_setup_entry,
    )
    from pytest_homeassistant_custom_component.common import MockConfigEntry
    from homeassistant.components.metservice_weather.const import DOMAIN
